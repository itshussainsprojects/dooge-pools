        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="contact-info lg:col-span-2">
            ...
            <div className="contact-items space-y-6">
              {[
                { icon: Phone, label: "Call Us", value: "+1 (555) 123-4567", color: "from-teal-500 to-cyan-500" },
                { icon: Mail, label: "Email Us", value: "hello@dogepools.com", color: "from-cyan-500 to-blue-500" },
                { icon: Clock, label: "Hours", value: "Mon-Sat: 8am-6pm", color: "from-blue-500 to-teal-500" },
                { icon: MapPin, label: "Service Area", value: "50-mile radius", color: "from-teal-500 to-emerald-500" },
              ].map((item, i) => (
                <motion.div 
                  key={i} 
